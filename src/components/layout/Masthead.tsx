...
export function Masthead({ module, section, index }: MastheadProps) {
  return (
    <header className="relative mb-8">
      ...
      <div className="mb-2 font-mono text-[11.5px] uppercase tracking-[0.14em] text-primary">
      ...
      <div className="mt-2 max-w-[70ch] text-[15.5px] text-muted-foreground">{module.subtitle}</div>
    </header>
  )
}
